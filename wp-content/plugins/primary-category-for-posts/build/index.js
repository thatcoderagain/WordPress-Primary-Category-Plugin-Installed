...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PrimaryCategory; });
...
let CategoryDropdown = props => {
  ...
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])(option.name)))));
};
...
CategoryDropdown = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["withDispatch"])(dispatch => {
  return {
    onMetaFieldChange: event => {
      dispatch('core/editor').editPost({
        meta: {
          pcfp_primary_category: event.target.value
        }
      });
    }
  };
...
function PrimaryCategory() {
  ...
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["AsyncModeProvider"], {
    value: true
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(CategoryDropdown, null)));
}
...
/* harmony import */ var _components_PrimaryCategory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/PrimaryCategory */ "./src/components/PrimaryCategory.js");
/**
...
Object(_wordpress_plugins__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"])('plugin-document-setting-panel-primary-category', {
  render: _components_PrimaryCategory__WEBPACK_IMPORTED_MODULE_1__["default"],
  icon: 'heart'
});
